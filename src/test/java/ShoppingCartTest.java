...
public class ShoppingCartTest {
    ...
    public void checkDiscount0() throws InterruptedException {
        ...
        driver.get("https://www.sharelane.com/cgi-bin/register.py?page=2&zip_code=12345&first_name=test&" + "last_name=test&email=test%40test.test&password1=12345678&password2=12345688");
        ...
        //Получить значения переменных таблицы, проверить правильность цен
